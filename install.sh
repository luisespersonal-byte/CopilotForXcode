...
if [[ -d "$APP_PATH" ]]; then
    ...
    # Fetch the download URL of the latest stable release asset
    # Note: the 'latest' endpoint intentionally skips pre-releases and drafts.
    ...
    # maxdepth 3 covers: archive root / optional top-level dir / .app bundle
